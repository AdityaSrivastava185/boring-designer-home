        ...
        <div className=" pt-7 md:my-14">
            <div className="md:flex flex-col md:items-center md:justify-center w-full">
                <div className=" md:py-14 md:px-7 max-w-[70%] md:w-full mx-auto">
                    ...
                    <h2 className="text-2xl md:text-7xl font-bold font-bebas md:tracking-tighter text-center uppercase max-w-[90%] mx-auto">Not everything powerful has to look complicated</h2>
                </div>
            </div>
