...
const AboutUs = () => {
    return (
        <div className=' pt-14 md:py-14'>
            ...
            <div>
                <p className='bebas font-bold md:text-2xl uppercase max-w-[70%] mx-auto text-justify text-muted-foreground'><span className='text-foreground'>boringdesigner</span> is a studio, zero-fluff design sprint for founders, indie hackers, and developers who are too busy building to waste time explaining <span className='text-foreground'>“what they want.”</span> We move fast, build sharper, and ship designs that feel unfairly good. <span className='text-foreground'>No agencies</span>. No bureaucracy. <span className='text-foreground'>Just high-trust, and obvisouly high-conviction collaboration</span>.</p>
            </div>
        </div>
    )
}
