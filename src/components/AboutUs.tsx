    ...
    return (
        <div className=' pt-14 md:py-14 md:px-24'>
            ...
            <div className=' border-b-1 border-border pb-14'>
                <h2 className=' text-md md:text-3xl bebas tracking-tighter uppercase mx-auto text-justify'>We&apos;re not your typical design studio.
            ...
            <div className='flex flex-col md:flex-row md:items-start md:justify-between mt-7 items-center justify-center'>
                <div className=''> <h1 className="text-center md:text-left text-2xl md:text-5xl font-bold md:font-bold bebas tracking-tight md:tracking-tighter text-foreground uppercase max-w-[70%] mx-auto">
