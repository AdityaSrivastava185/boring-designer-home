        ...
        <div>
            ...
            <div className='flex flex-col md:flex-row items-center justify-between w-full h-auto mx-auto md:my-10'>
                <div className='flex flex-col items-center justify-between w-full h-auto my-auto'>
                    ...
                    <div className='w-full'>
                        <h1 className='text-foreground text-bold text-5xl max-w-[40vw] text-wrap font-bold uppercase'>A necessary investment for your studio or your personal brand.</h1>
                    </div>
                </div>
                <div className='mt-10'>
            ...
            <div>
                <div className="mt-44 ">
                    <h2 className="text-center text-foreground text-5xl uppercase font-bold tracking-tight title">
                        design that doesn't confuse
                    </h2>
                    <h2 className="text-center text-7xl uppercase font-bold tracking-tight title">
