        ...
        <div className='py-17'>
            <div className=''>
                ...
                <div className='flex flex-col md:flex-row items-center justify-between w-full h-auto mx-auto md:my-10'>
                    <div className='flex flex-col items-center justify-between w-full h-auto my-14'>
                        ...
                        <div className="w-full">
                            <div className="w-full max-w-[80%] mx-auto md:mx-0">
                                <h1 className="text-center md:text-left text-3xl md:text-7xl font-bold capitalize md:font-medium bebas tracking-tight md:tracking-tighter text-foreground">
