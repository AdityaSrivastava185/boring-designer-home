  ...
  return (
    <>
      <div className=' md:max-w-4xl mx-auto'>
        ...
        <p className='text-xl text-center text-muted-foreground md:text-2xl font-medium text-balance md:max-w-2xl mx-auto mt-5'> stop overthinking. pick the damn template.download the code. break it. bend it. make it yours.build the sh*t you actually want to build — and launch.
